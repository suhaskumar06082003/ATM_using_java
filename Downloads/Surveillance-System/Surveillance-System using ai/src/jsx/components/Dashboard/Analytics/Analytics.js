...
const sampleData3 = [6,5,2,5,4,7,8,7,6,5,6,4,3,4,3,4,3,6,7,6];
 const tabData = [
      ...
      { name: "Shoplifting", content:"", },
      { name: "Explosion",content:"", },
      { name: "Stealing",content:"", },
	  { name: "Arson",content:"", },
	  { name: "More",content:"",  },
					...
					<div className="row">
								...
								<div className="card-body p-1">
									<div className="sp15 row border-bottom favorites-items p-3 align-items-center p-sm-4">
										<div className="col-xl-5 col-lg-5 col-sm-8 col-12 mb-3 mb-lg-0">
											<div className="media align-items-center">
												<Link to={"/ecom-product-detail"}>
													<img className="rounded mr-3" src={require("./../../../../images/card/Stealing.jpg").default} alt="" width="105" />
												</Link>	
												<div className="media-body">
													<h5 className="mb-2"><Link to={"/ecom-product-detail"} className="text-black" >Stealing</Link></h5>
													<div className="star-review fs-14 mb-2">
														...
														<i className="fa fa-star text-gray"></i>
														<span className="ml-5 text-dark">(139 Reports)</span>
													</div>
													<Link to={"#"}  className="text-primary fs-14 d-flex align-items-center"><i className="fa fa-heart fs-20 mr-2" aria-hidden="true"></i> <strong>131 Legit</strong> Check</Link>
												</div>
											</div>
										</div>
										<div className="col-xl-3 col-lg-3 col-sm-4 col-12 media align-items-center">
											...
											<div className="media-body">
												<h3 className="text-black font-w600 mb-1">99.2%</h3>
												<span className="text-black">Legitness</span>
											</div>
										</div>
										<div className="col-xl-2 col-lg-2 col-sm-6 col-6">
											<div className="d-flex align-items-flex-end mb-1">
												...
												<h3 className="text-black mb-0 font-w600 fs-22">138</h3>
											</div>
											<span className="text-black">Total Feedbacks</span>
										</div>
									...
									<div className="sp15 row border-bottom favorites-items p-3 align-items-center p-sm-4">
										<div className="col-xl-5 col-lg-5 col-sm-8 col-12 mb-3 mb-lg-0">
											<div className="media align-items-center">
												<Link to={"/ecom-product-detail"}>
													<img className="rounded mr-3" src={require("./../../../../images/card/Shoplifting.jpeg").default}alt="" width="105" />
												</Link>
												<div className="media-body">
													<h5 className="mb-2"><Link to={"/ecom-product-detail"} className="text-black" >Shoplifting</Link></h5>
													<div className="star-review fs-14 mb-2">
														<i className="fa fa-star text-orange"></i>
														<i className="fa fa-star text-orange"></i>
														<i className="fa fa-star text-orange"></i>
														<i className="fa fa-star text-gray"></i>
														<i className="fa fa-star text-gray"></i>
														<span className="ml-5 text-dark">(136 Reports)</span>
													</div>
													<Link to={"#"}  className="text-primary fs-14 d-flex align-items-center"><i className="fa fa-heart fs-20 mr-2" aria-hidden="true"></i> <strong>134 Legit </strong> Check</Link>
												</div>
											</div>
										</div>
										<div className="col-xl-3 col-lg-3 col-sm-4 col-12 media align-items-center">
											...
											<div className="media-body">
												<h3 className="text-black font-w600 mb-1">98.9%</h3>
												<span className="text-black">Legitness</span>
											</div>
										</div>
										<div className="col-xl-2 col-lg-2 col-sm-6 col-6">
											<div className="d-flex align-items-flex-end mb-1">
												...
												<h3 className="text-black mb-0 font-w600 fs-22">131</h3>
											</div>
											<span className="text-black">Total Feedbacks</span>
										</div>
										<div className="col-xl-2 col-lg-2 col-sm-6 col-6 text-right">
											<div className="d-inline-block relative donut-chart-sale">
												<Donught2
												   ...
												   cutoutPercentage="80"
												/>
												<small className="text-black fs-18"> 98.7%</small>
											</div>
										</div>
									</div>
									<div className="sp15 row border-bottom favorites-items p-3 align-items-center p-sm-4">
										<div className="col-xl-5 col-lg-5 col-sm-8 col-12 mb-3 mb-lg-0">
											<div className="media align-items-center">
												<Link to={"/ecom-product-detail"}>
													<img className="rounded mr-3" src={require("./../../../../images/card/Explosion.jpg").default} alt="" width="105" />
												</Link>	
												<div className="media-body">
													<h5 className="mb-2"><Link to={"/ecom-product-detail"} className="text-black" >Explosion</Link></h5>
													<div className="star-review fs-14 mb-2">
														<i className="fa fa-star text-orange"></i>
														<i className="fa fa-star text-orange"></i>
														<i className="fa fa-star text-orange"></i>
														<i className="fa fa-star text-gray"></i>
														<i className="fa fa-star text-gray"></i>
														<span className="ml-5 text-dark">(57 Reports)</span>
													</div>
													<Link to={"#"}  className="text-primary fs-14 d-flex align-items-center"><i className="fa fa-heart fs-20 mr-2" aria-hidden="true"></i> <strong>57 Legit </strong> Check</Link>
												</div>
											</div>
										</div>
										<div className="col-xl-3 col-lg-3 col-sm-4 col-12 media align-items-center">
											...
											<div className="media-body">
												<h3 className="text-black font-w600 mb-1">100%</h3>
												<span className="text-black">Legitness</span>
											</div>
										</div>
										<div className="col-xl-2 col-lg-2 col-sm-6 col-6">
											<div className="d-flex align-items-flex-end mb-1">
												...
												<h3 className="text-black mb-0 font-w600 fs-22">57</h3>
											</div>
											<span className="text-black">Total Feedbacks</span>
										</div>
										<div className="col-xl-2 col-lg-2 col-sm-6 col-6 text-right">
											<div className="d-inline-block relative donut-chart-sale">
												<Donught2
												   ...
												   cutoutPercentage="80"
												/>
												<small className="text-black fs-18"> 100%</small>
											</div>
										</div>
									</div>
								</div>
						...
						<div className="col-lg-8">
							<div className="card">
								<div className="card-header border-0">
									<div>
										<h4 className="card-title mb-2">Report Summary</h4>
											...
											<div className="chart-deta d-inline-block">
												<div className="col px-0">
													...
													<div>
														...
														<small className="font-w500 fs-14 text-muted">Events Recorded</small>
													</div>
												</div>
												<div className="col px-0">
													<span className="bg-warning"></span>	
													<div>
														<h4 className="fs-20 text-black font-w600 mb-1">63598</h4>
														<small className="font-w500 fs-14 text-muted">Normal (Safe)</small>
													</div>
												</div>
												<div className="col px-0">
													<span className="bg-danger"></span>	
													<div>
														<h4 className="text-black fs-20 font-w600 mb-1">342</h4>
														<small className="font-w500 fs-14 text-muted">Anomalous</small>
													</div>
												</div>
											</div>
										</div>
						...
						<div className="col-lg-4 col-md-6">
							<div className="card">
								<div className="card-header border-0 pb-0">
									<div>
										<h4 className="text-black">Reporters</h4>
										<p className="fs-14 mb-0">You, the owners</p>
									</div>
								</div>
								<div className="card-body">	
									<div className="media align-items-center mb-4">		
										...
										<div className="media-body">
											<h5 className="text-black"><Link to={"/app-profile"}  className="text-black">User 1</Link></h5>
											<small className="text-primary mb-0"><strong className="font-w600">176</strong>  times Report</small>
										</div>
									</div>
									<div className="media align-items-center mb-4">	
										<Link to={"/app-profile"} >
										...
										<div className="media-body">
											<h5 className="text-black"><Link to={"/app-profile"}  className="text-black">User 2</Link></h5>
											<small className="text-primary mb-0"><strong className="font-w600">132</strong>  times Report</small>
										</div>
									</div>
									<div className="media align-items-center mb-4">		
										<Link to={"/app-profile"} >
										...
										<div className="media-body">
											<h5 className="text-black"><Link to={"/app-profile"}  className="text-black">User 3</Link></h5>
											<small className="text-primary mb-0"><strong className="font-w600">112</strong>  times Report</small>
										</div>
									</div>
									<div className="media align-items-center">	
										<Link to={"/app-profile"} >
										...
										<div className="media-body">
											<h5 className="text-black"><Link to={"/app-profile"}  className="text-black">User 4</Link></h5>
											<small className="text-primary mb-0"><strong className="font-w600">98</strong>  times Report</small>
										</div>
									</div>
								</div>
						...
						<div className="col-lg-4 col-md-6">
							<div className="card">
								<div className="card-header border-0">
									<div>
										<h4 className="card-title mb-2">User Map</h4>
										<p className="fs-14 mb-0"></p>
									</div>
								</div>
						...
						<div className="col-lg-8">
							<div className="card">
								<div className="card-header border-0">
									<div>
										<h4 className="card-title mb-2">Anomalous Activites</h4>
										<p className="fs-14 mb-0"></p>
									</div>
									<Dropdown>
										<Dropdown.Toggle  as="button" type="button" className="btn border  btn-rounded text-black" >
