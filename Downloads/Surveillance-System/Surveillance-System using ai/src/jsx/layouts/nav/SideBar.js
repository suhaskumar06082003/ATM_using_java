          ...
          <MM className="metismenu" id="menu">
            ...
            <li className={`${app.includes(path) ? "mm-active" : ""}`}>
              <Link className="has-arrow ai-icon" to="#" >
                ...
                <span className="nav-text">Users and History</span>
              </Link>
              <ul >
                {/* <li>
                ...
                <li>
						<Link className={`${path === "Upload history" ? "mm-active" : ""}`} onClick={() => this.props.onClick()} to="/order-list">
							Upload history
						</Link>
					</li>
					<li>
             ...
             <li className={`${plugins.includes(path) ? "mm-active" : ""}`}>
               <Link className="has-arrow ai-icon" to="#" >
                ...
                <span className="nav-text">Video Stream</span>
              </Link> 
               <ul >
                <li>
					    <Link className={`${path === "uc-select2" ? "mm-active" : ""}`} onClick={() => this.props.onClick()} to="/webcam">Get Streaming</Link>
                </li>
                {/* <li>
            ...
            <li className={`${redux.includes(path) ? "mm-active" : ""}`}>
                <Link className="has-arrow ai-icon" to="#" >
                    <i className="flaticon-381-book"></i><span className="nav-text">Test</span>
                </Link>
                <ul>
            ...
            <li className={`${forms.includes(path) ? "mm-active" : ""}`}>
              <Link className="has-arrow ai-icon" to="#" >
                ...
                <span className="nav-text forms">Upload Recording</span>
              </Link>
              <ul >
                 {/* <li>
                ...
                <li>
                  <Link className={`${ path === "form-validation-jquery" ? "mm-active" : "" }`} onClick={() => this.props.onClick()} to="/form-validation-jquery">Monitor Recording</Link>
                </li> 
              </ul>
            </li>
